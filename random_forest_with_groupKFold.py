...
class random_forest_with_groupKFold:
    ...
    def train(self, data_path):
        ...
        print("Running GroupKFold cross-validation (by cpu_model)...")
...
if __name__ == "__main__":
    ...
    if path:
        ...
        algo = random_forest_with_groupKFold(args.target, args.trees, args.seed)
        algo.train(path)
        algo.save_model(f"model_{args.target}.pkl")

    else:
        print("You need to have TRAINIG_DATA_PATH specified in .env file")
